...
function i18nTitle() {
    return window.onlineI18n?.title || (isIndonesian() ? "LAPORAN PENGGUNA ONLINE" : "ONLINE USER REPORT");
}
...
function exportToPDF(dt) {
    ...
    var fname = isIndonesian()
        ? "Laporan-Aktivitas-Pengguna-DABB.pdf"
        : "User-Activity-Report-DABB.pdf";
...
function exportToCSV(dt) {
    ...
    var fname = isIndonesian()
        ? "Laporan-Aktivitas-Pengguna-DABB.csv"
        : "User-Activity-Report-DABB.csv";
...
function exportToExcel(dt) {
    ...
    var fname = isId
        ? "Laporan-Aktivitas-Pengguna-DABB.xls"
        : "User-Activity-Report-DABB.xls";
