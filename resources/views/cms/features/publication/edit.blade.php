                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        ...
                        <div class="relative group aspect-square rounded-lg overflow-hidden border border-gray-200 bg-gray-50">
                            ...
                            <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                <label class="cursor-pointer bg-red-500 text-white px-2 py-1 rounded text-xs flex items-center gap-1">
                                    <input type="checkbox" name="existing_images[]" value="{{ $img }}" checked class="hidden peer">
                                    <span class="peer-checked:inline hidden">Simpan</span>
                                    <span class="peer-not-checked:inline hidden">Hapus</span>
                                </label>
                            </div>
                        </div>
                        @endforeach
