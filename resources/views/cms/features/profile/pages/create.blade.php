    ...
    <div class="px-4 py-6 max-w-7xl mx-auto sm:px-6 lg:px-8" x-data="profilePageForm()">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div class="lg:col-span-2">
                <form action="{{ route('cms.features.profile.pages.store', $feature) }}" method="POST"
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        ...
                        <div class="border border-gray-300 rounded-lg bg-white"
                            ...
                            <div id="preview-wrapper" style="display: block; width: 1200px; padding: 0 15px; position: relative;">
                                <div id="preview-container" class="profile-section-desc" style="transform-origin: top left; transition: transform 0.2s ease; background: transparent; width: 100%; border: none; padding: 0; position: relative;">
