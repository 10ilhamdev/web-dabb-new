            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="pt-6 border-t border-gray-100 space-y-4">
                        ...
                        <div class="mb-4 p-3 bg-blue-50 border border-blue-100 rounded-lg flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button type="button" onclick="this.closest('.mb-4').remove()" class="px-2.5 py-1 bg-red-100 hover:bg-red-200 text-red-600 rounded-lg text-xs font-semibold transition-colors flex items-center gap-1" title="Hapus Dokumen">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6" x-cloak x-show="type === 'statis'">
                    ...
                    <div class="pt-6 border-t border-gray-100 space-y-4">
                        ...
                        <div class="mb-4 p-3 bg-blue-50 border border-blue-100 rounded-lg flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <svg class="w-8 h-8 text-blue-50-500" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z"></path>
                                </svg>
                                <div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6" x-cloak x-show="type === 'perpustakaan'">
                                ...
                                <template x-for="(rule, index) in lib_rules" :key="index">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <button type="button" @click="removeLibRule(index)" class="p-1.5 bg-red-50 hover:bg-red-100 text-red-600 rounded-lg border border-red-200 transition-colors">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-1:0V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                                        </button>
                                    </div>
                                </template>
                            </div>
                    ...
                    <div class="pt-6 border-t border-gray-100 space-y-4">
                        ...
                        <div class="space-y-2">
                            <label class="block text-xs font-semibold text-gray-700">Foto Terunggah Saat Ini (Hapus jika ingin mengganti/menghilangkan):</label>
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                                ...
                                <div class="p-2 bg-blue-50 border border-blue-100 rounded-lg flex items-center justify-between gap-2 shadow-sm">
                                    ...
                                    <div class="shrink-0">
                                        ...
                                        <button type="button" onclick="this.closest('.p-2').remove()" class="p-1 bg-red-100 hover:bg-red-200 text-red-600 rounded text-xs font-semibold transition-colors" title="Hapus Foto">
                        ...
                        {{-- Tambah Foto Baru --}}
                        <div class="pt-2">
                            <label class="block text-xs text-gray-500 mb-1">Tambah Beberapa Foto Baru (Bisa lebih dari 1)</label>
                            <div class="flex items-center gap-2">
                                <div class="relative overflow-hidden shrink-0">
                            ...
                            <span class="text-[10px] text-gray-500 block mt-1">Foto baru yang dipilih di sini akan ditambahkan ke daftar foto yang sudah ada.</span>
                        </div>
                    </div>
                    ...
                    <div class="pt-6 border-t border-gray-100 space-y-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <input type="text" name="extra_data[lib_pdf_name]" x-model="lib_pdf_name" placeholder="Nama file (otomatis)" class="flex-1 px-3 py-1.5 border border-gray-200 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-blue-50 bg-white">
                        </div>
                    </div>
                </div>
            </div>
