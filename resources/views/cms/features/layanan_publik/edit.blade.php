                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="mt-2 flex flex-col gap-1.5">
                                ...
                                <label class="inline-flex items-center cursor-pointer text-xs text-gray-600 font-medium">
                                    <input type="checkbox" name="extra_data[is_login_required]" value="1" {{ !empty($layananPublik->extra_data['is_login_required']) ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 focus:ring-blue-500 w-4 h-4 mr-1.5">
