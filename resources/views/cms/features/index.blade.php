                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                @if($feature->is_active)
                                    {{-- If active, click opens visibility modal to choose hide mode --}}
                                    <button type="button"
                                        @click="openVisibilityModal({{ $feature->id }}, '{{ addslashes($feature->name) }}')"
                                ...
                                @else
                                    {{-- If hidden, click directly submits form to show it --}}
