...
@endsection
@section('breadcrumb_active', __('cms.kontak_kami.add_button'))

@section('content')
<div class="px-4 py-6 max-w-7xl mx-auto sm:px-6 lg:px-8" x-data="kontakKamiForm(null)">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">{{ __('cms.kontak_kami.create_title') }}</h1>
        </div>
    </div>

    <form action="{{ route('cms.features.kontak_kami.pages.store', $feature) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <input type="text" name="title" required placeholder="{{ __('cms.kontak_kami.placeholder_title') }}"
                ...
                {{-- Media Images --}}
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <label class="block text-sm font-medium text-gray-700 mb-1.5">{{ __('cms.kontak_kami.label_gallery') }}</label>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">{{ __('cms.kontak_kami.label_subtitle') }}</label>
                            <textarea name="subtitle" rows="3" placeholder="{{ __('cms.kontak_kami.placeholder_subtitle') }}"
...
<script src="{{ asset('js/cms/features/kontak_kami/create.js') }}?v={{ time() }}"></script>
@endpush
