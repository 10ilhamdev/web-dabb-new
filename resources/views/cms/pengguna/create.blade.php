...
<div class="space-y-6">
    ...
    <form id="formPengguna" action="{{ route('cms.pengguna.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            {{-- Password --}}
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1.5">{{ __('cms.pengguna.form_password') }} <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1.5">{{ __('cms.pengguna.form_password_confirmation') }} <span class="text-red-500">*</span></label>
